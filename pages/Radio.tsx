  ...
  return (
    <div className="max-w-[1440px] mx-auto px-6 py-20 flex flex-col items-center">
      ...
      <div className="text-center mb-16 w-full">
        <span className="text-xs font-bold uppercase tracking-[0.4em] mb-4 block">
          <Editable id="radio_pretitle" defaultText="noPROPZZ_RADIO" />
        </span>
        <h1 className="text-8xl md:text-[12rem] lg:text-[15rem] font-black tracking-tighter italic uppercase leading-none">
                  ...
                  <tr key={track.id} className="group hover:bg-black hover:text-white transition-colors cursor-pointer">
                    ...
                    <td className="p-4 border-r-2 border-black">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[9px] opacity-40 group-hover:opacity-100 uppercase tracking-widest">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center bg-zinc-900 p-8 md:p-12 brutalist-border brutalist-shadow">
            ...
            <div className="flex flex-col justify-center space-y-8 text-white">
              <div>
                ...
                <p className="text-[10px] font-mono opacity-50 mt-2 uppercase tracking-widest">
      ...
      <div className="mt-40 w-full border-t-4 border-black py-24 flex flex-col items-center justify-center bg-white">
