...
const Home: React.FC = () => {
  ...
  return (
    <div>
      ...
      <section className="bg-black text-white py-24 md:py-48 px-6 border-y-4 border-black relative">
        <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row justify-between items-center gap-16 lg:gap-24">
          <div className="max-w-3xl text-center lg:text-left">
            <motion.h2 
              ...
              className="text-5xl sm:text-6xl md:text-8xl font-black tracking-tighter uppercase mb-10 md:mb-12 leading-[0.8]"
            >
              <Editable id="mission_title_1" defaultText="REAL HUMAN" /><br/>
              <Editable id="mission_title_2" defaultText="STORIES FIRST." /><br/>
              <span className="italic text-zinc-500">
                <Editable id="mission_title_3" defaultText="AI SCALE SECOND." />
              </span>
            </motion.h2>
            <div className="text-xl md:text-3xl font-mono font-bold leading-tight opacity-80 uppercase">
              <Editable 
                id="mission_desc" 
                defaultText="A Scandinavian creative agency creating campaigns for conscious brands. We lead with real human creativity, using AI thoughtfully to scale globally, building connections that last." 
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 w-full lg:w-auto">
            <motion.div 
              ...
              className="p-10 md:p-14 border-4 border-white brutalist-shadow bg-zinc-900 flex flex-col items-center lg:items-start text-center lg:text-left transition-all"
            >
               <ShieldCheck className="mb-8 text-white" size={40} />
               <h4 className="text-2xl font-black uppercase mb-3 italic">
                 <Editable id="stat_1_title" defaultText="SUSTAINABLE" />
               </h4>
               <p className="text-[10px] font-mono opacity-50 uppercase tracking-[0.4em]">
            ...
            <motion.div 
              ...
              className="p-10 md:p-14 border-4 border-white brutalist-shadow bg-zinc-900 flex flex-col items-center lg:items-start text-center lg:text-left transition-all"
            >
               <Globe className="mb-8 text-white" size={40} />
               <h4 className="text-2xl font-black uppercase mb-3 italic">
      ...
      <section className="pt-12 md:pt-24 pb-4 px-6 max-w-[1440px] mx-auto">
        <header className="mb-20 md:mb-32 flex flex-col md:flex-row justify-between items-start md:items-end border-b-4 border-black pb-12 md:pb-16">
           <div className="mb-10 md:mb-0">
              <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.5em] opacity-30">THE_ENTRY_POINTS</span>
              <h2 className="text-6xl sm:text-7xl md:text-9xl font-black mt-6 tracking-tighter italic uppercase">
           ...
           <Link 
             ...
             className="text-xl md:text-2xl font-black uppercase tracking-widest hover:opacity-50 transition-all flex items-center space-x-6 group"
           >
             <span>View All Packages</span>
             <ArrowRight size={32} strokeWidth={3} className="group-hover:translate-x-4 transition-transform duration-300" />
           </Link>
        </header>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-16">
          {/* AI Spark Kit */}
          <div className="bg-white border-4 border-black p-10 md:p-14 brutalist-shadow-hover transition-all flex flex-col">
            <div className="flex justify-between items-start mb-10">
               <Zap size={48} className="text-black" />
               <span className="bg-black text-white px-4 py-2 text-[10px] font-black uppercase tracking-widest italic">
            ...
            <div className="text-lg font-mono font-bold opacity-70 mb-12 leading-relaxed flex-grow uppercase">
            ...
            <div className="pt-10 border-t-4 border-black flex justify-between items-center">
               ...
               <Link 
                 ...
                 onClick={handleLinkClick}
                 className="bg-black text-white px-8 py-6 text-xs font-black uppercase tracking-widest flex items-center space-x-4"
               >
                 <span>Initiate</span>
                 <ArrowRight size={20} />
               </Link>
          ...
          {/* Destination Drop */}
          <div className="bg-black text-white p-10 md:p-14 brutalist-shadow transition-all flex flex-col">
            <div className="flex justify-between items-start mb-10">
               <Globe size={48} />
               <span className="bg-white text-black px-4 py-2 text-[10px] font-black uppercase tracking-widest italic">
                 <Editable id="offer_2_tag" defaultText="Global Production" />
               </span>
            </div>
            <h3 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-6 italic leading-none">
            ...
            <div className="pt-10 border-t-4 border-white flex justify-between items-center">
               <span className="text-3xl font-black tracking-tighter italic">
               ...
               <Link 
                 to={isEditing ? '#' : '/contact'} 
                 onClick={handleLinkClick}
                 className="bg-white text-black px-8 py-6 text-xs font-black uppercase tracking-widest flex items-center space-x-4"
               >
                 <span>Reserve</span>
                 <ArrowRight size={20} />
               </Link>
          ...
          {/* Story Partner */}
          <div className="bg-zinc-100 border-4 border-black p-10 md:p-14 brutalist-shadow-hover transition-all flex flex-col">
            <div className="flex justify-between items-start mb-10">
      ...
      {/* Portfolio Preview */}
      <section className="pt-2 md:pt-4 pb-24 md:pb-48 px-6 max-w-[1440px] mx-auto">
        <div className="border-t-4 border-black pt-4 md:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-16 md:mb-24 gap-8">
             <h3 className="text-5xl md:text-7xl font-black tracking-tighter uppercase leading-none italic">
               <Editable id="port_preview_title" defaultText="Recent_Deployments" />
             </h3>
             <Link to="/portfolio" className="text-xl md:text-2xl font-black uppercase tracking-widest hover:opacity-50 transition-all flex items-center space-x-6 group" onClick={handleLinkClick}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-0 border-l-4 border-t-4 border-black">
            {MOCK_PROJECTS.slice(0, 3).map((project) => (
              <Link 
                ...
                onClick={handleLinkClick}
                key={project.id}
                className="group border-r-4 border-b-4 border-black p-10 md:p-14 hover:bg-zinc-50 transition-all"
              >
                <div className="aspect-[4/5] bg-gray-200 overflow-hidden border-2 border-black mb-8 md:mb-10">
                  <img 
                ...
                <h4 className="text-3xl md:text-4xl font-black uppercase tracking-tighter leading-none">{project.title}</h4>
                <p className="text-[10px] md:text-xs font-mono opacity-50 mt-4 md:mt-6 uppercase font-bold tracking-[0.3em]">{project.category} // {project.year}</p>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="pt-12 md:pt-24 pb-24 md:pb-48 bg-zinc-50 px-6 border-t-4 border-black">
        <div className="max-w-[1440px] mx-auto">
          <header className="mb-20 md:mb-32 flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
             <div>
                <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.5em] opacity-30">LIMITED_EDITIONS</span>
                <h2 className="text-6xl sm:text-7xl md:text-9xl font-black mt-6 tracking-tighter uppercase leading-none italic">
                  <Editable id="shop_preview_header" defaultText="THE_6_BEST_PRINTS" />
                </h2>
             </div>
             <Link to="/shop" className="text-xl md:text-2xl font-black uppercase tracking-widest hover:opacity-50 transition-all flex items-center space-x-6 group" onClick={handleLinkClick}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-16 md:gap-20">
                ...
                <div className="relative aspect-[4/5] bg-white border-4 border-black overflow-hidden brutalist-shadow transition-all group-hover:shadow-none group-hover:translate-x-2 group-hover:translate-y-2">
                  ...
                  <div className="absolute top-4 right-4 flex flex-col gap-2 z-20">
                    <button 
                      ...
                      className="bg-white p-4 border-2 border-black hover:bg-black hover:text-white transition-all transform translate-x-16 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 duration-500"
                    >
                      <ShoppingBag size={24} />
                    </button>
                  </div>
                ...
                <div className="mt-10 flex justify-between items-start px-2">
                  <div className="flex-grow">
                    ...
                    <Link 
                      ...
                      onClick={handleLinkClick}
                    >
                      <h3 className="text-3xl font-black uppercase tracking-tighter mt-1 italic group-hover:not-italic transition-all">
            ...
            {isEditing && (
              ...
              >
                ...
                <p className="text-[8px] opacity-40 font-mono font-bold uppercase">(Will appear in Shop archive)</p>
              </button>
            )}
          </div>
        </div>
